...
const myPrimaryColor = '#B13232';
const mySecondaryColor = "#eec3c3";
...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : myPrimaryColor,
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : myPrimaryColor,
  footerPaddingBottom: 0,

  // FooterTab
  tabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : mySecondaryColor,
  tabBarTextSize: platform === PLATFORM.IOS ? 14 : 11,
  activeTab: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  sTabBarActiveTextColor: '#007aff',
  tabBarActiveTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : myPrimaryColor,

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : myPrimaryColor,
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : myPrimaryColor,
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : myPrimaryColor,
  ...
  radioSelectedColorAndroid: myPrimaryColor,
  ...
  // Segment
  segmentBackgroundColor: platform === PLATFORM.IOS ? '#F8F8F8' : myPrimaryColor,
  segmentActiveBackgroundColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentTextColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentActiveTextColor: platform === PLATFORM.IOS ? '#fff' : myPrimaryColor,
  segmentBorderColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : myPrimaryColor,
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : myPrimaryColor,
  topTabBarTextColor: platform === PLATFORM.IOS ? '#6b6b6b' : mySecondaryColor,
